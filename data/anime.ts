...
export const animeList: Anime[] = [
  ...
  },
  {
    ...
    titleJa: 'ダリフラ',
    tagline: '終末世界で戦う少年少女の、禁じられた感情と純粋な愛の物語',
    image: 'https://cdn.myanimelist.net/images/anime/1614/90408l.jpg',
    synopsis:
      '荒廃した未来世界。人類はプランテーションと呼ばれる移動要塞に住み、「叫竜」と呼ばれる巨大生物と戦い続けていた。少年少女たちはフランクスと呼ばれる人型兵器に男女ペアで搭乗し、戦闘に従事する。落ちこぼれのコードナンバー016・ヒロは、謎の少女ゼロツーと出会い、彼女の相棒「ダーリン」として戦場へ赴く。A-1 Pictures・Trigger・CloverWorks共同制作の2018年放送、全24話。',
    review:
      '前半はゼロツーとヒロのひたむきな関係性と、閉塞した世界での少年少女の葛藤が丁寧に描かれており、引き込まれる展開が続く。ゼロツーの圧倒的なキャラクター人気は社会現象となり、「ダーリン」というセリフは当時流行語にもなった。後半は宇宙・宗教的な要素が加わり賛否両論を呼んだが、ヒロとゼロツーの関係の結末は胸に刺さる。不完全燃焼な部分もありながら、忘れられない作品として心に残る一作。',
    rating: 4,
    highlights: [
      'ゼロツーの唯一無二なキャラクター性と圧倒的な存在感',
      '前半の閉塞した世界観と少年少女の感情描写の丁寧さ',
      'ヒロとゼロツーの純粋で切ない関係性',
      'TriggerとA-1 Picturesが融合した独特の映像美',
      '社会現象を巻き起こしたキャラクターの魅力',
    ],
    recommended_for: [
      'SF・ロボットアニメが好きな人',
      '切ない恋愛描写のあるアニメを求めている人',
      'ディストピア的な世界観が好きな人',
      'Triggerアニメのファン',
    ],
    not_for: ['後半の展開含め完成度を求める人', 'ロボット戦闘メインを期待している人'],
    info: {
      year: 2018,
      episodes: 24,
      studio: 'A-1 Pictures / Trigger',
      genre: ['SF', 'ロボット', '恋愛', 'アクション'],
      status: '完結',
    },
    related: ['re-zero', 'sword-art-online'],
    tags: ['ダリフラ', 'ゼロツー', 'Trigger', 'ロボット', 'ディストピア'],
    era: '2010s',
    updatedAt: '2026-02-26',
  },
];
